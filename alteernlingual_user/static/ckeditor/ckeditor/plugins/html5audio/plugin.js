CKEDITOR.plugins.add( 'html5audio', {
    ...
    init: function( editor ) {
        editor.widgets.add( 'html5audio', {
            ...
            template: '<span class="ckeditor-html5-audio"></span>',  
             ...
             *  - span-s with text-align,float,margin-left,margin-right inline style rules and required ckeditor-html5-audio class.
             *  - audio tags with src and controls attributes.
             */
            allowedContent: 'span(!ckeditor-html5-audio){text-align,float,margin-left,margin-right}; audio[src,controls,controlslist,autoplay];',
            requiredContent: 'span(ckeditor-html5-audio); audio[src,controls];',
            upcast: function( element ) {
                return element.name === 'span' && element.hasClass( 'ckeditor-html5-audio' );
            },
            dialog: 'html5audio',
            init: function() {
