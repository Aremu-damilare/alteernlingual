...
(function(audiojs, audiojsInstance, container) {
  ...
  container[audiojs] = {
    ...
    // Inject a wrapping span and the markup for the html player.
    ...
    injectFlash: function(audio, id) {
      ...
      span.innerHTML = flashSource + html;
      audio.wrapper.innerHTML = span.innerHTML;
    ...
    helpers: {
      ...
      cloneHtml5Node: function(audioTag) {
        ...
        span.innerHTML = audioTag.outerHTML;
